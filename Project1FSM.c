...
#define STATES {INIT_STATE_LOC, \
    READ_USERNAME_STATE_LOC,\
    PROCESS_NUMBER_STATE_LOC,\
    PROCESS_ASCII_STATE_LOC,\
    READ_PASSWORD_STATE_LOC,\
    INCORRECT_STATE_LOC,\
    LOGGED_IN_STATE_LOC}
...
State FSM[7] = {
                 {init_state,STATES},
                 {read_username_state,STATES},
                 {process_number_state,STATES},
                 {process_ascii_state,STATES},
                 {read_password_state,STATES},
                 {incorrect_state,STATES},
                 {logged_in_state,STATES}
};
